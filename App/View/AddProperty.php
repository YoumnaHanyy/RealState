...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // If no errors, insert property into database
    if (empty($errors)) {
        // Prepare SQL statement
        $stmt = $conn->prepare("INSERT INTO properties (name, price, developer, location, image) VALUES (?, ?, ?, ?, ?)");
            ...
            <div class="dashboard-content">
                <div class="page-header">
                    ...
                    <div class="breadcrumb">
                        <a href="AdminDashboard.php">Home</a> / <a href="properties.php">Properties</a> / <span>Add Property</span>
                    </div>
                </div>
                ...
                <div class="content-card">
                    ...
                    <div class="card-body">
                        <form id="addPropertyForm" class="form-grid" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
                            <!-- Property Image -->
                            <div class="form-group full-width">
                                <div class="user-profile-header">
                                    <div class="user-avatar">
                                        <img src="https://via.placeholder.com/150x150.png?text=Property+Image" alt="Property Image" id="propertyPreview">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="propertyName" name="name" value="<?php echo htmlspecialchars($formData['name']); ?>" required>
                            </div>
                            
                            <div class="form-group">
                                <label for="propertyPrice">Price</label>
                                <input type="number" id="propertyPrice" name="price" step="0.01" value="<?php echo htmlspecialchars($formData['price']); ?>" required>
                            </div>
                            
                            <div class="form-group">
                                <label for="propertyDeveloper">Developer</label>
                                <input type="text" id="propertyDeveloper" name="developer" value="<?php echo htmlspecialchars($formData['developer']); ?>" required>
                            </div>
                            
                            <div class="form-group">
                                <label for="propertyLocation">Location</label>
                                <select id="propertyLocation" name="location" required>
                                    <option value="" disabled <?php echo empty($formData['location']) ? 'selected' : ''; ?>>Select Location</option>
                                    <option value="Cairo" <?php echo $formData['location'] == 'Cairo' ? 'selected' : ''; ?>>Cairo</option>
                                    <option value="Giza" <?php echo $formData['location'] == 'Giza' ? 'selected' : ''; ?>>Giza</option>
                                    <option value="Alexandria" <?php echo $formData['location'] == 'Alexandria' ? 'selected' : ''; ?>>Alexandria</option>
                                    <option value="Other" <?php echo $formData['location'] == 'Other' ? 'selected' : ''; ?>>Other</option>
                                </select>
                            </div>
